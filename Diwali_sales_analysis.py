...
mf = sns.countplot(x = 'Gender', data=df, palette=custom_palette,hue='Gender', legend=True)
...
salesplot = sns.barplot(x = 'Gender', y = 'Amount', data = salesvalue, palette=custom_palette, hue='Gender', legend=True)
...
mf = sns.countplot(x = 'Age Group', data=df, palette=custom_palette,hue = 'Gender',legend=True)
...
salesplot = sns.barplot(x = 'Age Group', y = 'Amount', data = salesage, palette=custom_palette, hue = 'Age Group', legend=True)
for container in salesplot.containers:
  salesplot.bar_label(container, fmt='{:,.0f}')
plt.show()
...
salesplot = sns.barplot(x = 'State', y = 'Orders', data = salesstate, palette=custom_palette, hue = 'State', legend=True)
for container in salesplot.containers:
  salesplot.bar_label(container, fmt='{:,.0f}')
plt.show()
...
salesplot = sns.barplot(x = 'State', y = 'Amount', data = salesstate, palette=custom_palette, hue = 'State', legend=True)
for container in salesplot.containers:
  salesplot.bar_label(container, fmt='{:,.0f}')
plt.show()
...
ms = sns.countplot(x = 'Marital_Status', data=df, palette=custom_palette, hue = 'Marital_Status', legend=True)
...
salesplot = sns.barplot(x = 'Marital_Status', y = 'Amount', data = maritalstatus, palette=custom_palette, hue = 'Gender',legend=True)
for container in salesplot.containers:
  salesplot.bar_label(container, fmt='{:,.0f}')
plt.show()
...
oc = sns.countplot(x = 'Occupation', data=df, palette=custom_palette, hue = 'Occupation', legend=True)
...
pc = sns.countplot(y = 'Product_Category', data=df, palette=custom_palette, hue = 'Product_Category', legend=False)
...
salesplot = sns.barplot(x = 'Product_Category', y = 'Amount', data = productcategory, palette=custom_palette, hue = 'Product_Category',legend=True)
for container in salesplot.containers:
  salesplot.bar_label(container, fmt='{:,.0f}')
plt.show()
...
salesplot = sns.barplot(x = 'Product_ID', y = 'Orders', data = productid, palette=custom_palette, hue = 'Product_ID',legend=True)
for container in salesplot.containers:
  salesplot.bar_label(container, fmt='{:,.0f}')
plt.show()
